...
public:
    ...
    //Creates a new city with the given name. When the city is created you need to restore it's population from a file.
    //Hint: You will want to make the file name be based on the name of the city.
    City(string cityName);
    
    //This is the destructor for the city. When this city is destroyed, save the population of the city to a file so that you can restore it in the constructor the next time that a city with this name is created.
    ~City();
    ...
    //Adds a citizen to this city. You will need to make a copy of this citizen so that you make sure to keep it around for the life of the city.
