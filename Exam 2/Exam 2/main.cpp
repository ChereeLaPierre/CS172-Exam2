...
int main()
{
    ...
    /*
    You chose those names and Ids becauase they are mountain bikers and that is the order in which they placed in the Red Bull Rampage.
    */
